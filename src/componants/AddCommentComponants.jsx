...
const AddComment = (props) => {
  ...
  const handleDeleteComment=async(postId,commentId)=>{
   ...
   let res=await axios.delete(`https://blog-app-eza5.onrender.com/posts/deletecomment/${postId}/${commentId}`)
  ...
  <MDBInput ref={commentRef} placeholder="Type comment..." label="+ Add a comment.." />
                    <button style={{height:"40px"}} className='btn btn-success ' onClick={() => submitCommentHandler(props.ele._id)}>submit</button>
                  </div>
            ...
            <div className="d-flex flex-row align-items-center">
                ...
                src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(4).webp"
                 ...
                 />} */}
                   <CardHeader
        avatar={
          <Avatar sx={{bgcolor:red[500]}} style={{bgcolor:"red"}} aria-label="recipe">
            {item.user.name[0]}
          </Avatar>
        }
    ...
    {/* //      <MDBIcon
        ...
        icon="thumbs-up mx-2 fa-xs text-black"
         style={{ marginTop: "-0.16rem" }}
          /> */}
         <MdDelete onClick={()=>handleDeleteComment(props.ele._id,item._id)} size={20}  style={{cursor:'pointer'}} />
